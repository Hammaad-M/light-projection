...
function updateProjection() {
    ...
    if (xPoint != lastxPoint || yPoint != lastyPoint || z != lastZ || refresh == true || lastData != data) {
        ...
        intensities.forEach((a, i) => {
            ...
            //console.log(modifiedIntensities);
        })
        //console.log("angles: " + angles[0] + " z: " + z + " p: " + p);

        if (refresh == true || lastData != data) {
            chartResults(angles, modifiedIntensities);
        }
        ...
        if (overlay) {
            ...
            line(halfWidth - (xLength/2), halfHeight, halfWidth + (xLength/2), halfHeight);
            line(halfWidth, halfHeight - (yLength/2), halfWidth, halfHeight + (yLength/2));
        }
    }
